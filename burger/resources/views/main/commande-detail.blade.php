...
<head>
    <meta charset="utf-8">
    <title>Z'Burger - Details Commande</title>
    <!-- Stylesheets -->
            ...
            <div class="cart-outer">
                <div class="table-outer">
                    <table class="cart-table">
                        ...
                        <tbody>
                        @foreach($commande_proudits as $produit)
                            <tr>
                                <td class="prod-column">
                                    <div class="column-box">
                                        <figure class="prod-thumb"><img src="{{asset('/images/'.$produit->photos)}}"
                                                                        alt="#"></figure>
                                    </div>
                                </td>
                                <td>
                                    <h4 class="prod-title" th:text="${lc.getProduit().getNom()}">{{$produit->nom}}</h4>
                                </td>
                                <td class="sub-total" th:text="${lc.getProduit().getPrix()} +'€'">{{$produit->prix}}€</td>
                                <td class="qty">
                                    <span th:text="${lc.getQuantite()}">{{$produit->pivot->quantity}}</span>
                                </td>
                                <td class="price" th:text="(${lc.getProduit().getPrix()} * ${lc.getQuantite()}) +''">
                                    {{$produit->pivot->prixTotal}}€
                                </td>
                ...
                <div class="row clearfix">
                    ...
                    <div class="column pull-right col-lg-5 col-md-12 col-sm-12">
                        ...
                        "><span class="col">Sous Total</span>
                                <span class="col" >{{$commande->prix - 4}}€</span>
                            </li>
                            <li class="clearfix"><span class="col">Livraison</span><span class="col">4.0€</span>
                            </li>
                            <li class="clearfix total"><span class="col">Total</span><span
                                    class="col price" th:text="${commandeClient.getPrix()} + '€'">{{$commande->prix}}€</span></li>
                        </ul>
                    </div>
                </div>
            </div>
