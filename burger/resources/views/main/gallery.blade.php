...
">
                            ...
                            <div class="collapse navbar-collapse clearfix" id="navbarSupportedContent">
                                <ul class="navigation clearfix">
                                    ...
                                    <li class="current"><a href="{{route('gallery')}}">Galerie</a></li>
        ...
        <div class="auto-container">
            <div class="row clearfix">
                        ...
                        <div class="image">
                            ...
                            <div class="overlay-box">
                                <div class="overlay-inner">
                                    <a href="{{asset('assets/images/gallery/6.jpg')}}" data-fancybox="gallery" data-caption=""
                ...
                <div class="gallery-block-two col-lg-4 col-md-6 col-sm-12">
                    <div class="inner-box">
                        <div class="image">
                            ...
                            <div class="overlay-box">
                                <div class="overlay-inner">
                                    <a href="{{asset('assets/images/gallery/7.jpg')}}" data-fancybox="gallery" data-caption=""
                                       class="link"><span class="icon flaticon-expand"></span></a>
                                    <h5><a href="#"></a></h5>
                                </div>
                            </div>
                ...
                <div class="gallery-block-two col-lg-4 col-md-6 col-sm-12">
                    <div class="inner-box">
                        <div class="image">
                            ...
                            <div class="overlay-box">
                                <div class="overlay-inner">
                                    <a href="{{asset('assets/images/gallery/8.jpg')}}" data-fancybox="gallery" data-caption=""
                                       class="link"><span class="icon flaticon-expand"></span></a>
                                    <h5><a href="#"></a></h5>
                                </div>
                            </div>
                ...
                <div class="gallery-block-two col-lg-4 col-md-6 col-sm-12">
                    <div class="inner-box">
                        <div class="image">
                            ...
                            <div class="overlay-box">
                                <div class="overlay-inner">
                                    <a href="{{asset('assets/images/gallery/9.jpg')}}" data-fancybox="gallery" data-caption=""
                                       class="link"><span class="icon flaticon-expand"></span></a>
                                    <h5><a href="#"></a></h5>
                                </div>
                            </div>
                ...
                <div class="gallery-block-two col-lg-4 col-md-6 col-sm-12">
                    <div class="inner-box">
                        <div class="image">
                            ...
                            <div class="overlay-box">
                                <div class="overlay-inner">
                                    <a href="{{asset('assets/images/gallery/10.jpg')}}" data-fancybox="gallery" data-caption=""
                                       class="link"><span class="icon flaticon-expand"></span></a>
                                    <h5><a href="#"></a></h5>
                                </div>
                            </div>
                ...
                <div class="gallery-block-two col-lg-4 col-md-6 col-sm-12">
                    <div class="inner-box">
                        <div class="image">
                            ...
                            <div class="overlay-box">
                                <div class="overlay-inner">
                                    <a href="{{asset('assets/images/gallery/11.jpg')}}" data-fancybox="gallery" data-caption=""
                                       class="link"><span class="icon flaticon-expand"></span></a>
                                    <h5><a href="#"></a></h5>
                                </div>
                            </div>
                ...
                <div class="gallery-block-two col-lg-4 col-md-6 col-sm-12">
                    <div class="inner-box">
                        <div class="image">
                            ...
                            <div class="overlay-box">
                                <div class="overlay-inner">
                                    <a href="{{asset('assets/images/gallery/12.jpg')}}" data-fancybox="gallery" data-caption=""
                                       class="link"><span class="icon flaticon-expand"></span></a>
                                    <h5><a href="#"></a></h5>
                                </div>
                            </div>
                ...
                <div class="gallery-block-two col-lg-4 col-md-6 col-sm-12">
                    <div class="inner-box">
                        <div class="image">
                            <img src="{{asset('assets/images/gallery/13.jpg')}}" alt=""/>
                            <!-- Overlay Box -->
                            <div class="overlay-box">
                                <div class="overlay-inner">
                                    <a href="{{asset('assets/images/gallery/13.jpg')}}" data-fancybox="gallery" data-caption=""
                                       class="link"><span class="icon flaticon-expand"></span></a>
                                    <h5><a href="#"></a></h5>
                                </div>
                            </div>
                ...
                <div class="gallery-block-two col-lg-4 col-md-6 col-sm-12">
                    <div class="inner-box">
                        <div class="image">
                            <img src="{{asset('assets/images/gallery/14.jpg')}}" alt=""/>
                            <!-- Overlay Box -->
                            <div class="overlay-box">
                                <div class="overlay-inner">
                                    <a href="{{asset('assets/images/gallery/14.jpg')}}" data-fancybox="gallery" data-caption=""
                                       class="link"><span class="icon flaticon-expand"></span></a>
                                    <h5><a href="#"></a></h5>
                                </div>
                            </div>
