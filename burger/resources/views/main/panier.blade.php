                        ...
                        <table class="cart-table">
                            ...
                            @foreach($panier_produits as $produit)
                                <tr>
                                    <td class="prod-column">
                                        <div class="column-box">
                                            <figure class="prod-thumb">
                                                <a href="{{ route('produits', $produit->id) }}">
                                    ...
                                    <td>
                                        <a href="{{ route('produits', $produit->id) }}">
                                            <h4 class="prod-title">{{$produit->nom}}</h4>
                                        </a>
                                    </td>
                                    <td class="sub-total">{{$produit->prix}}€</td>
                                    <td class="qty">
                                        <span th:text="${pp.getQuantite()}">{{$produit->pivot->quantity}}</span>
                                    </td>
                                    <td class="price">
                                        {{$produit->prix * $produit->pivot->quantity}}€
                                    </td>
                                    <td>
                                        <form method="post"
                                              action="{{ route('panier.destroy',  ['id' => $produit->id]) }}">
                                            @csrf
                                            @method('delete')
                ...
                @if(sizeof($panier_produits))
                    ...
                    <div class="row clearfix">
                        ...
                        <div class="column pull-right col-lg-5 col-md-12 col-sm-12">
                            ...
                            <br>
                            <br>
                            <ul class="totals-table" th:if="${panierProduitList.size() != 0}">
                                <li>
                                    <h3>Totals</h3>
                                </li>
                                <li class=" clearfix
                        "><span class="col">Sous Total</span>
                                ...
                                <li class="clearfix total"><span class="col">Total</span><span
                                        class="col price">{{$total_livraison}}€</span>
                                </li>
                                <li class="text-right">
                                    <a href="{{route("checkout")}}">
                                        <button type="submit"
                                                class="theme-btn btn-style-five proceed-btn"><span
                                                class="txt">Paiement</span>
                                        </button>
                                    </a>
                                </li>
                            </ul>
                ...
                <div class="row clearfix">
                    ...
                    <div class="footer-column col-lg-3 col-md-6 col-sm-12">
                        ...
                        <div class="footer-widget info-widget">
                            ...
                            <ul class="email-list">
                                <li><a href="mailto:contact@zbuger.fr ">contact@zburger.fr</a></li>
